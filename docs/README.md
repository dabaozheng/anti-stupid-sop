# 防蠢SOP文檔 | Anti-Stupid SOP Docs

## 理念 | Philosophy
這是一套在極端壓力下淬煉而成的「5分鐘防蠢決策框架」，用4步驟幫你堵住90%的低級錯誤。
This is a "5-Minute Anti-Stupidity Decision Framework" forged under extreme pressure, helping you block 90% of basic mistakes with 4 steps.
...
- No reliance on IQ, only on process
- Complete a full check in 5 minutes
- Applicable to all decision scenarios: work, startups, life
- Co-created with AI, continuously iterable and optimizable
...
## 🚀 Quick Start (10 seconds) / 🚀 快速使用（10秒看懂）
...
## 📝 Anti-Stupidity SOP Checklist / 📝 防蠢 SOP 自我檢查表

### 1. Parrot Mode (Alignment) / 一、復讀機模式（校準）
- [ ] I repeated the request in my own words.
- [ ] I confirmed vague terms (e.g., “ASAP” means today EOD, not tomorrow morning).
...
### 2. Three-Path Planning (No Single Answers) / 二、三路推演（拒絕單選題）
- [ ] Path A (Conservative): safest, guaranteed to work.
- [ ] Path B (Standard): balanced, meets expectations.
- [ ] Path C (Breakthrough): best possible outcome if resources/time aren’t an issue.
...
### 3. Devil’s Advocate (Red Team) / 三、找碴視角（紅隊測試）
- [ ] I attacked my own plan from an opponent’s perspective.
- [ ] I identified the weakest link and prepared a fallback.
...
### 4. Layperson Validation (Value Translation) / 四、外行驗證（價值轉譯）
- [ ] I can explain my plan in three sentences to someone outside my field.
- [ ] I focused on “results” and “benefits,” not “process.”
...
## 📌 Real Examples / 📌 真實填寫範例（一看就會）

### Example 1: Workplace Task / 範例1：職場需求確認

| Step / 步驟 | What I Wrote / 填寫內容 |
|------|--------------|
| **Parrot Mode / 復讀機模式** | Boss: “Do a competitive analysis ASAP.” My understanding: deliver key differences by EOD. Confirmed “ASAP” means today. |
| **Three-Path / 三路推演** | A: Top 3 competitors, slide deck. B: 5 competitors with data tables. C: 10 competitors + user reviews. |
| **Devil’s Advocate / 找碴視角** | Weakest link: data sources might be unreliable. Backup: pre-verify two trusted sources, note data dates. |
| **Layperson / 外行驗證** | “Give the boss the main differences between our top 3 competitors in five minutes, so he knows where we should go.” |

### Example 2: Project Kickoff / 範例2：專案立項決策

| Step / 步驟 | What I Wrote / 填寫內容 |
|------|--------------|
| **Parrot Mode / 復讀機模式** | Client: “We want a product with high-end aesthetics.” My understanding: minimalist, premium look. Confirmed “aesthetics” means clean, not flashy. |
| **Three-Path / 三路推演** | A: Small tweaks to existing template. B: Redesign visuals, keep structure. C: Full brand identity overhaul. |
| **Devil’s Advocate / 找碴視角** | Weakest link: option C might slip timeline. Backup: add two-week buffer, ship core pages first. |
| **Layperson / 外行驗證** | “Make the client feel ‘this looks expensive and impressive’ the moment they open the page.” |
