# 🔥 5分鐘防蠢決策SOP｜4步堵住90%低級錯誤（AI協作實戰版）
# 🚀 5-Minute Anti-Stupidity SOP | 4 Steps to Block 90% of Stupid Mistakes (AI-Co-Created Battle Tested Version)
...
### 🧭 目錄導航 | Navigation
- 📚 [詳細文檔與說明](./docs/README.md)
- 🧪 [實戰案例與模板](./examples/template.md)
- ⚙️ [核心SOP檢查清單](./core/checklist.md)
